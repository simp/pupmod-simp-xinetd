...
%changelog
* Wed Jul 01 2015 Nick Miller <nick.miller@onyxpoint.com> - 3.0.0-0
- Refactored module according to new SIMP module guidelines
- xinetd::service is now xinetd::config::xinetd_service
